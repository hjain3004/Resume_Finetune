...
bullet edits. Preserve each leading action verb and the complete numeric-token
multiset. Do not emit a resume, structure, before text, JD quotes, diff, or change log.
